...
void main()
{
  ...
  ellipse(210,123,0,360,13,20);/*×ó±ßµÄÑÛ¾¦*/
  ellipse(265,123,0,360,13,20);/*ÓÒ±ßµÄÑÛ¾¦*/
  ellipse(210,133,0,360,10,10);/*×ó±ßµÄÑÛÇò*/
  ellipse(265,133,0,360,10,10);/*ÓÒ±ßµÄÑÛÇò*/
  ellipse(210,133,0,360,3,3);/*×ó±ßµÄÑÛÇò*/
  ellipse(265,133,0,360,3,3);/*ÓÒ±ßµÄÑÛÇò*/
  ellipse(238,160,0,360,10,13);/*±Ç×Ó*/
  arc(240,125,228,312,68);/*×ì°Í*/
  arc(240,120,230,310,72);/*×ì°Í*/
  setfillstyle(1,4);
  floodfill(238,160,15);/*±Ç×Ó*/
  setfillstyle(1,15);
